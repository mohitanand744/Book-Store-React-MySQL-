            ...
            <div>
              ...
              <p className="opacity-80">
                {itemTrackingData.item_status === "DELIVERED" ? (
                  <span>
                    Your order has been{" "}
                    <b className="text-green-600">successfully delivered</b> to
                    your address.
                  </span>
                ) : (
                  <>
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-[#D3BD9D]/30 p-8">
              <div className="relative">
                ...
                <div className="absolute top-6 left-0 w-full px-[10%] -z-0">
                  ...
                  >
                    <span class="absolute right-0 -top-1 flex h-4 w-4">
                      <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#5C4C49] opacity-75"></span>
                      <span class="relative inline-flex rounded-full h-4 w-4 bg-[#5C4C49]"></span>
                    </span>
                  </motion.div>
                </div>
              </div>

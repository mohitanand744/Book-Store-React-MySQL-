                                  ...
                                  <div className="flex flex-col gap-2 mt-3 sm:flex-row sm:items-center sm:justify-between">
                                    <div className="flex items-center text-sm">
                                      ...
                                      <span className="ml-2">
                                        ...
                                        <span className="text-gray-600">
                                          {getDeliveryLabel(item?.item_status)}
                                    ...
                                    {item?.tracking_id ? (
                                      <button
                                        onClick={() =>
                                          navigate(
                                            `/nextChapter/tracking/${order?.order_id}/${item?.order_item_id}`
                                          )
                                        }
                                      ...
                                      <button className="px-3 py-1 text-xs bg-orange-300 hover:bg-[#5C4C49] text-[#fff] hover:text-white rounded-full transition-colors">
                                        Not Shipped
                                      </button>
                                    ) : null}
                                  </div>

    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F6F2EB] to-[#F6F2EB]">
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          >
            Our <span className="text-[#b1946a]">Story</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <b>NextChapter</b> began as a shared dream between friends in 2018.
            Today, we're a community of 50,000+ readers discovering new worlds
            together.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
